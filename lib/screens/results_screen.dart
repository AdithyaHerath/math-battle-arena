...
class _ResultsScreenState extends State<ResultsScreen> {
  ...
  Future<void> _saveStats() async {
    ...
    final isSinglePlayer = args['isSinglePlayer'] as bool? ?? false;
    ...
    if (isSinglePlayer) {
      // For single player, just update accuracy
      await authVM.updateStatsAfterGame(
        didWin: null, // no win/loss
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        if (!isSinglePlayer) _statRow('Your HP', '$myHp'),
                        if (!isSinglePlayer)
